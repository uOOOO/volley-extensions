...
public class VolleyerRequestTest {
	...
	public void constructorShouldThrowNpeWhenHttpContentIsNull() {
		...
		// Then
		new VolleyerRequest<String>(nullHttpContent, clazz, responseParser, listener, errorListener, retryPolicy);
	}
	...
	public void constructorShouldThrowNpeWhenTargetClassIsNull() {
		...
		// Then
		new VolleyerRequest<String>(httpContent, nullClazz, responseParser, listener, errorListener, retryPolicy);
	}
	...
	public void constructorShouldThrowNpeWhenListenerIsNull() {
		...
		// Then
		new VolleyerRequest<String>(httpContent, clazz, responseParser, nullListener, errorListener, retryPolicy);
	}
	...
	public void constructorShouldThrowNpeWhenResponseParserIsNull() {
		...
		// Then
		new VolleyerRequest<String>(httpContent, clazz, nullResponseParser, listener, errorListener, retryPolicy);
	}
	...
	public void httpMethodShouldBeSameWithThatOfHttpContent() {
		...
		Request<String> request =
				new VolleyerRequest<String>(httpContent, clazz, responseParser, listener, errorListener, retryPolicy);
		// Then
	...
	public void targetClassShouldBeSameWithParameterOfConstructor() {
		// When
		VolleyerRequest<String> request =
				new VolleyerRequest<String>(httpContent, clazz, responseParser, listener, errorListener, retryPolicy);
		// Then
	...
	public void responseShouldFailWhenNetworkResponseParserIsWrong() {
		...
		// When
		VolleyerRequest<String> request =
				new VolleyerRequest<String>(httpContent, clazz, otherResponseParser, listener, errorListener, retryPolicy);
		Response<String> response = request.parseNetworkResponse(networkResponse);
		// Then
	...
	public void responseShouldBeDeliveredWhenDeliveredResponseIsCalled() {
		...
		// When
		VolleyerRequest<String> request =
				new VolleyerRequest<String>(httpContent, clazz, responseParser, testListener, errorListener, retryPolicy);
